...
from DFOL.model.predict_extract import return_all_predicate
...
def main():
    task_name = 'umls'
    logic_program_path= 'DFOL/'+task_name+'/result/ntps.pl'
    newpl_path =  'DFOL/'+task_name+'/result/'
    # Get all predicate name
    all_predicate = return_all_predicate(task_name)
