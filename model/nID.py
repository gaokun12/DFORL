...
import numpy as np
import DFOL.model.DLFIT as DLFIT
import argparse
import itertools
...
def train(x, y, max_epochs=10000, learning_rate= 0.02, decay_rate= 1, model_path = None ,
          verbose = 1, patience = 100, figure_path = None, batch_size = 32, 
          validation_split = 0.2 ,loss_weight=None, relation_number = None, prior_knowledge = False):
